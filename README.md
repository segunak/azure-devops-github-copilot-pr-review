...
>
> **Looking Ahead:** VS Code is [shipping plugin support](https://www.reddit.com/r/GithubCopilot/comments/1rbegd8/plugin_support_finally_coming_to_vscode/) ([source](https://x.com/orenme/status/2025289705173188810)) that will let you bundle agents, instructions, and prompts as a single installable package with versioning and distribution. This project is exactly the kind of thing that becomes a one-command install when that lands. Instead of copying Markdown files into your repo, you'd install an extension and go. For now, you run a scaffolding prompt that generates everything. The platform keeps catching up!
